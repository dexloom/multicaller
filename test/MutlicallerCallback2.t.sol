...
contract MulticallerCallback2Test is Test, Helper {
    ...
    function testCallErcInsideUni2CallbackArray2() public {
        ...
        bytes memory callData3 = abi.encodeWithSignature("swap(uint256,uint256,address,bytes)", 0x11111,0x0, address(multicaller), callDataArray);
    ...
    function testCallErcInsideUni3CallbackArray() public {
        ...
        bytes memory callData3 = abi.encodeWithSignature("swap(address,bool,int256,uint160,bytes)", addr, true, 0x11111, 0x0,  callDataArray);
        bytes memory callDataArray3 = abi.encodePacked(
...
function testCallErcInsidePancake3CallbackArray() public {
        ...
        bytes memory callData2 = abi.encodeWithSignature("swap(address,bool,int256,uint160,bytes)", addr, true, 0x11111, 0x0,  callDataArray);
