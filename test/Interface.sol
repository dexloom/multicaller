...
interface MultiCaller {
    ...
    function transferTipsMinBalanceNoPayout(
        address token,
        uint256 minBalance,
        uint256 tips
    ) external payable;
    ...
    function uni2GetInAmountFrom0Comms(
        address pool,
        uint256 amount,
        uint256 fee
    ) external;
    function uni2GetInAmountFrom1Comms(
        address pool,
        uint256 amount,
        uint256 fee
    ) external;
    function uni2GetOutAmountFrom0Comms(
        address pool,
        uint256 amount,
        uint256 fee
    ) external;
    function uni2GetOutAmountFrom1Comms(
        address pool,
        uint256 amount,
        uint256 fee
    ) external;
