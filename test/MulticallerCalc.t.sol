...
contract MulticallerCalcTest is Test, Helper {
    ...
    function testCalcLoadUint() public {
        ...
        uint256 ret = multicaller.doCalls( 
          mergeData( address(0), vmCode, CALCULATION_CALL_SELECTOR, 0xFFFFF,0xFFFFF) 
        );
    ...
    function calcCheck(uint8 opcodeRevert , uint8 opcodeReturn , uint256 ok_arg0 , uint256 ok_arg1 , uint256 fail_arg0 , uint256 fail_arg1, bytes memory revertMsg ) public {
        bytes[3] memory script0 = [
