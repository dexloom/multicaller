...
contract MulticallerPayoutTest is Test, Helper {
  ...
  function testCallTransferTipsMinBalanceCallArray_Transfer() public {
        ...
        bytes memory callData3 = abi.encodeWithSignature("transferTipsMinBalance(address,uint256,uint256,address)", address(erc20Mock2), 10, 5, address(0x8888) );
    ...
    function testCallTransferTipsMinBalanceCallArray_NoTip() public {
        ...
        bytes memory callData = abi.encodeWithSignature("balanceOf(address)", addr);
        bytes memory callData2 = abi.encodeWithSignature("transfer(address,uint256)", addr2, 100);
        bytes memory callData3 = abi.encodeWithSignature("transferTipsMinBalance(address,uint256,uint256,address)", address(erc20Mock2), 0, 0, address(0x8888) );
        bytes memory callDataArray = abi.encodePacked(
      ...
      function testCallTransferTipsMinBalanceCallArrayRevert() public {
        ...
        bytes memory callData = abi.encodeWithSignature("balanceOf(address)", addr);
        bytes memory callData2 = abi.encodeWithSignature("transfer(address,uint256)", addr2, 100);
        bytes memory callData3 = abi.encodeWithSignature("transferTipsMinBalance(address,uint256,uint256,address)", address(erc20Mock2), 10000000, 5, address(0x8888) );
        bytes memory callDataArray = abi.encodePacked(
            Helper.mergeData(address(erc20Mock2), callData2, Helper.ZERO_VALUE_CALL_SELECTOR,0xFFFFFF,0xFFFFFF),
            Helper.mergeData(address(0x1111), callData3, Helper.INTERNAL_CALL_SELECTOR, 0xFFFFFF,0xFFFFFF),
    ...
    function testCallTransferTipsMinBalanceWethCallArray_Revert() public {
        ...
        bytes memory callData = abi.encodeWithSignature("balanceOf(address)", addr);
        bytes memory callData2 = abi.encodeWithSignature("transfer(address,uint256)", addr2, 100);
        bytes memory callData3 = abi.encodeWithSignature("transferTipsMinBalanceWETH(uint256,uint256,address)", 1000000000000, 5, address(0x7777));
        bytes memory callDataArray = abi.encodePacked(
            mergeData(address(erc20Mock2), callData2, Helper.ZERO_VALUE_CALL_SELECTOR,0xFFFFFF,0xFFFFFF),
            mergeData(address(0x1111), callData3, Helper.INTERNAL_CALL_SELECTOR,0xFFFFFF,0xFFFFFF),
            mergeData(address(erc20Mock), callData, Helper.STATIC_CALL_SELECTOR,0xFFFFFF,0xFFFFFF)
    ...
    function testCallTransferTipsMinBalanceNoPayoutCallArray_Revert() public {
        ...
        bytes memory callData = abi.encodeWithSignature("balanceOf(address)", addr);
        bytes memory callData2 = abi.encodeWithSignature("transfer(address,uint256)", addr2, 100);
        bytes memory callData3 = abi.encodeWithSignature("transferTipsMinBalanceNoPayout(address,uint256,uint256)", WETHAddress, 1000000000, 5);
        bytes memory callDataArray = abi.encodePacked(
            mergeData(address(erc20Mock2), callData2, Helper.ZERO_VALUE_CALL_SELECTOR,0xFFFFFF,0xFFFFFF),
            mergeData(address(0x1111), callData3, Helper.INTERNAL_CALL_SELECTOR,0xFFFFFF,0xFFFFFF),
            mergeData(address(erc20Mock), callData, Helper.STATIC_CALL_SELECTOR,0xFFFFFF,0xFFFFFF)
