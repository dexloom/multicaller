...
interface IShibaswapV2Callee {
    function shibaswapV2Call(address sender, uint amount0, uint amount1, bytes calldata data) external;
}
...
contract ShibaswapV2Pair {
    ...
    function swap(uint amount0Out, uint amount1Out, address to, bytes calldata data) public {
        IShibaswapV2Callee(to).shibaswapV2Call(msg.sender, amount0Out, amount1Out, data);
    }
}
