...
contract MulticallerTest is Test, Helper {
    ...
    function testCallErcInside20CallArray() public {
        ...
        multicaller.doCalls(abi.encodePacked(
            mergeData(address(multicaller), callDoCallsData, ZERO_VALUE_CALL_SELECTOR,0xFFFFFF,0xFFFFFF)));
        //assertEq(counter.number(), 22);
    }
    ...
    function testCallErcInside20DelegateCallArray() public {
        ...
        multicaller.doCalls(abi.encodePacked(
            mergeData(address(multicaller), callDoCallsData, DELEGATE_CALL_SELECTOR,0xFFFFFF,0xFFFFFF)));
        //assertEq(counter.number(), 22);
    }
